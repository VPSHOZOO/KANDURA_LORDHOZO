...
console.log("=== LORDHOZOO DDOS BOT ===");
console.log("Silakan login terlebih dahulu");

// Login system
readline.question('Username: ', (username) => {
  readline.question('Password: ', (password) => {
    if (username !== 'hozoo' || password !== '123456') {
      console.log("❌ API KEY SALAH");
      readline.close();
      process.exit(1);
    }

    console.log("✅ API KEY BENAR ");
    console.log("=======================");

    // Prompt for BOT_TOKEN and ADMIN_ID after successful login
    readline.question('Enter your bot token: ', (BOT_TOKEN) => {
      readline.question('Enter your admin chat ID: ', (ADMIN_ID) => {
        readline.close();
